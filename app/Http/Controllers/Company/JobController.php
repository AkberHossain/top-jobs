...
class JobController extends Controller
{
    ...
    public function storeJobCreateForm(Request $request)
    {
        ...
        foreach ($request->job_salaries as $job_salary)
        {
            Job_Salary::Create([
        ...
        foreach ($request->job_experiences as $job_experience)
        {
        ...
        foreach ($request->job_industries as $job_industry)
        {
            Job_Industry::Create([
        ...
        //creating job career_levels
        foreach ($request->job_qualifications as $job_qualification)
        {
