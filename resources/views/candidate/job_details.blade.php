            ...
            <div>
                ...
                <div class="collapse" id="collapseExample">
                    <div class="card card-body">
                        ...
                        <a href="{{ route('candidate.show-job-apply-form' , $job->id) }}" class="btn btn-outline-primary btn-block btn-lg text-center"><h5 class="text-danger">Submit resume and Apply</h5></a>
